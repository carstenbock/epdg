...
init() ->
    ...
    lists:foreach(fun(K) -> ets:insert_new(?TAB, {K, 0}) end, [
        ...
        gtpc_create_bearer_req_total,
        gtpc_update_bearer_req_total,
        gtpc_delete_bearer_req_total,
        gtpc_bearer_resp_total,
        gtpc_bearer_no_context_total,
        gtpu_tx_bytes,
        gtpu_rx_bytes,
        gtpu_tx_pkts,
        gtpu_rx_pkts,
        ...
        gtpu_echo_req_rx_total,
        gtpu_echo_rsp_tx_total,
        gtpu_echo_rsp_rx_total,
        gtpu_rx_undecodable_total,
